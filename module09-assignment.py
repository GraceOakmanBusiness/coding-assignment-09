...
#loadig and exploring the given dataset 
...
print("1. Increase promotions on high-performing products like PhoneX to boost revenue.")
print("2. Focus inventory in top regions (North America & Europe) where sales are strongest.")
print("3. Address missing pricing data to improve accuracy of financial analysis.")